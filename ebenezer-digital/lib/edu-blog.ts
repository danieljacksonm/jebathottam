...
const IMG = {
  ...
  wifi: [
    "https://images.unsplash.com/photo-1606904825846-647eb07f5eeb?auto=format&fit=crop&w=1400&q=80",
  ...
  ai: [
    ...
    "https://images.unsplash.com/photo-1675557009875-436f71457475?auto=format&fit=crop&w=1400&q=80",
    "https://images.unsplash.com/photo-1655720033654-a4239f728c49?auto=format&fit=crop&w=1400&q=80",
  ],
  computer: [
    "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=1400&q=80",
    "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1400&q=80",
    "https://images.unsplash.com/photo-1587831990711-23ca6441447b?auto=format&fit=crop&w=1400&q=80",
  ...
  security: [
    "https://images.unsplash.com/photo-1563986768494-4dee2763ff36?auto=format&fit=crop&w=1400&q=80",
  ...
  data: [
    ...
    "https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&w=1400&q=80",
    "https://images.unsplash.com/photo-1639322537504-6427a16b0a91?auto=format&fit=crop&w=1400&q=80",
  ],
  business: [
...
export const EDU_TOPICS: EduTopic[] = [
  ...
  t("ip-address", "an IP address", "Internet & Networks", "like a home address for a device on the network", "An IP address is a number label that helps the internet deliver packets to the right device.", ["Your network gives you an address.", "Packets carry from and to addresses.", "Routers read them like street signs.", "NAT can share one public address."], ["IPv4 and IPv6 are two styles.", "Addresses can change on home Wi‑Fi."], "Addresses make delivery possible on the net.", IMG.internet),
  t("domain-name", "a domain name", "Internet & Networks", "like a easy name instead of a hard number address", "A domain name (like example.com) is a memorable label that points to servers on the internet.", ["You type a name.", "DNS finds the IP.", "Browser connects.", "The site loads."], ["Domains are rented, not forever owned blindly.", "HTTPS locks the trip."], "Good domains help brands and journals get found.", IMG.web),
];
