...
/** 
 * Topic-specific curated Unsplash images.
 * Every key maps to exactly 7 unique photos (one per angle) so each blog post gets its own cover.
 * Format: w=1600&q=90&fit=crop&crop=center for sharp, well-cropped professional shots.
 */
...
const IMG: Record<string, string[]> = {
  electricity: [
    ...
    `https://images.unsplash.com/photo-1470116945706-e6bf5d5a53ca?${Q}`,
    `https://images.unsplash.com/photo-1545208698-8e858b6c7b62?${Q}`,
    `https://images.unsplash.com/photo-1522199755839-a2bacb67c546?${Q}`,
  ],
  battery: [
    `https://images.unsplash.com/photo-1598550476439-6847785fcea6?${Q}`,
    `https://images.unsplash.com/photo-1563460716037-460a3ad24ba9?${Q}`,
    `https://images.unsplash.com/photo-1617788138017-80ad40651399?${Q}`,
    `https://images.unsplash.com/photo-1609942072337-c3370eb8b2c4?${Q}`,
    `https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?${Q}`,
  ...
  "solar-power": [
    `https://images.unsplash.com/photo-1509391366360-2e959784a276?${Q}`,
    `https://images.unsplash.com/photo-1466611653911-0072c762b24b?${Q}`,
    `https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?${Q}`,
    `https://images.unsplash.com/photo-1548337138-e87d889cc369?${Q}`,
    `https://images.unsplash.com/photo-1624397640148-949b1732bb0a?${Q}`,
    `https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?${Q}`,
    `https://images.unsplash.com/photo-1592833423562-c18b8cc3f843?${Q}`,
  ],
  circuit: [
    `https://images.unsplash.com/photo-1518770660439-4636190af475?${Q}`,
    `https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?${Q}`,
    `https://images.unsplash.com/photo-1601132359864-c974e79890ac?${Q}`,
    `https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?${Q}`,
    `https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?${Q}`,
    `https://images.unsplash.com/photo-1555664424-778a1e5e1b48?${Q}`,
    `https://images.unsplash.com/photo-1612838320302-4b3b3996e345?${Q}`,
  ],
  "led-light": [
    `https://images.unsplash.com/photo-1529310399831-ed472b81d589?${Q}`,
    `https://images.unsplash.com/photo-1558618666-fcd25c85cd64?${Q}`,
    `https://images.unsplash.com/photo-1507822033-da9e35aebb11?${Q}`,
    `https://images.unsplash.com/photo-1563461660947-507ef49e9c47?${Q}`,
    `https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?${Q}`,
  ...
  internet: [
    ...
    `https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?${Q}`,
    `https://images.unsplash.com/photo-1521790365971-81e94e0b9ff4?${Q}`,
  ],
  wifi: [
    `https://images.unsplash.com/photo-1606904825846-647eb07f5eeb?${Q}`,
    ...
    `https://images.unsplash.com/photo-1588600878108-578307a3cc9d?${Q}`,
    `https://images.unsplash.com/photo-1544197150-b99a580bb7a2?${Q}`,
  ],
  "mobile-data": [
    ...
    `https://images.unsplash.com/photo-1556656793-08538906a9f8?${Q}`,
  ...
  dns: [
    ...
    `https://images.unsplash.com/photo-1547658719-da2b51169166?${Q}`,
  ...
  ai: [
    ...
    `https://images.unsplash.com/photo-1531746790731-6c087fecd65a?${Q}`,
    `https://images.unsplash.com/photo-1485827404703-89b55fcc595e?${Q}`,
    `https://images.unsplash.com/photo-1675557009875-436f71457475?${Q}`,
    `https://images.unsplash.com/photo-1655720033654-a4239f728c49?${Q}`,
    `https://images.unsplash.com/photo-1507146153580-69a1fe6d8aa1?${Q}`,
  ],
  "chatgpt-style-ai": [
    `https://images.unsplash.com/photo-1655720033654-a4239f728c49?${Q}`,
    `https://images.unsplash.com/photo-1677442136019-21780ecad995?${Q}`,
  ...
  smartphone: [
    ...
    `https://images.unsplash.com/photo-1592890288564-76628a30a657?${Q}`,
    `https://images.unsplash.com/photo-1523206489230-c012c64b2b48?${Q}`,
    `https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?${Q}`,
  ],
  app: [
  ...
  "camera-sensor": [
    ...
    `https://images.unsplash.com/photo-1502920917128-1aa500764cbd?${Q}`,
    `https://images.unsplash.com/photo-1452780212272-89ccc5547b6c?${Q}`,
    `https://images.unsplash.com/photo-1580910051074-3eb694886505?${Q}`,
    `https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?${Q}`,
    `https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?${Q}`,
  ],
  password: [
    `https://images.unsplash.com/photo-1563986768494-4dee2763ff36?${Q}`,
    `https://images.unsplash.com/photo-1555949963-aa79dcee981c?${Q}`,
    `https://images.unsplash.com/photo-1614064641938-3bbee52942c7?${Q}`,
    `https://images.unsplash.com/photo-1633265486064-086b219458ec?${Q}`,
    `https://images.unsplash.com/photo-1550751827-4bd374c3f58b?${Q}`,
    `https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?${Q}`,
    `https://images.unsplash.com/photo-1480694313141-fce5e697ee25?${Q}`,
  ],
  "2fa": [
    `https://images.unsplash.com/photo-1614064641938-3bbee52942c7?${Q}`,
    `https://images.unsplash.com/photo-1563986768494-4dee2763ff36?${Q}`,
  ...
  cloud: [
    ...
    `https://images.unsplash.com/photo-1544197150-b99a580bb7a2?${Q}`,
    `https://images.unsplash.com/photo-1558494949-ef010cbdcc31?${Q}`,
    `https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?${Q}`,
    `https://images.unsplash.com/photo-1519389950473-47ba0277781c?${Q}`,
    `https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?${Q}`,
  ],
  server: [
  ...
  database: [
    ...
    `https://images.unsplash.com/photo-1639322537504-6427a16b0a91?${Q}`,
    `https://images.unsplash.com/photo-1460925895917-afdab827c52f?${Q}`,
    `https://images.unsplash.com/photo-1544197150-b99a580bb7a2?${Q}`,
    `https://images.unsplash.com/photo-1558494949-ef010cbdcc31?${Q}`,
  ],
  ...
  ecommerce: [
    ...
    `https://images.unsplash.com/photo-1522202176988-66273c2fd55f?${Q}`,
  ...
  "whatsapp-business": [
    `https://images.unsplash.com/photo-1577563908411-5077b6dc7624?${Q}`,
    `https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?${Q}`,
    `https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?${Q}`,
    `https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?${Q}`,
    `https://images.unsplash.com/photo-1556656793-08538906a9f8?${Q}`,
  ...
  "ui-kit": [
    `https://images.unsplash.com/photo-1609921212029-bb5a28e60960?${Q}`,
    `https://images.unsplash.com/photo-1587440871875-191322ee64b0?${Q}`,
    `https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?${Q}`,
    `https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?${Q}`,
    `https://images.unsplash.com/photo-1460925895917-afdab827c52f?${Q}`,
    `https://images.unsplash.com/photo-1547658719-da2b51169166?${Q}`,
    `https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?${Q}`,
  ...
  email: [
    ...
    `https://images.unsplash.com/photo-1596526131083-e8c633c948d2?${Q}`,
    `https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?${Q}`,
    `https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?${Q}`,
    `https://images.unsplash.com/photo-1563986768494-4dee2763ff36?${Q}`,
    `https://images.unsplash.com/photo-1451187580459-43490279c0fa?${Q}`,
  ...
  streaming: [
    `https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?${Q}`,
    `https://images.unsplash.com/photo-1536240478700-b869ad10e128?${Q}`,
    `https://images.unsplash.com/photo-1593359677879-a4bb92f4834c?${Q}`,
    `https://images.unsplash.com/photo-1558618666-fcd25c85cd64?${Q}`,
    `https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?${Q}`,
    `https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?${Q}`,
    `https://images.unsplash.com/photo-1580910051074-3eb694886505?${Q}`,
  ...
  gps: [
    `https://images.unsplash.com/photo-1524661135-423995f22d0b?${Q}`,
    `https://images.unsplash.com/photo-1502920917128-1aa500764cbd?${Q}`,
    `https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?${Q}`,
    `https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?${Q}`,
    `https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?${Q}`,
  ...
  // Default fallback for topics without dedicated images
  _default: [
    `https://images.unsplash.com/photo-1498050108023-c5249f4df085?${Q}`,
    `https://images.unsplash.com/photo-1517694712202-14dd9538aa97?${Q}`,
    `https://images.unsplash.com/photo-1551288049-bebda4e38f71?${Q}`,
...
function t(
  ...
  funFacts: string[],
  whyItMatters: string,
  _images?: string[] // ignored — images are now looked up by key in topicImages()
): EduTopic {
...
function buildContent(topic: EduTopic, angle: EduAngle, title: string): string {
  ...
  const keyTakeaways = topic.steps
    .slice(0, 3)
    .map((s) => `✓ ${s}`)
    .join("\n");

  const base = `## Let's start with a simple picture\n\nThink of ${topic.titleBase} ${topic.metaphor}. Keep that picture in your mind. We will use easy words, like a class for 10–11 year olds.\n\n${topic.what}\n\n> **In one line:** ${topic.whyItMatters}\n\n## Why should you care?\n\n${topic.whyItMatters} When you understand ${topic.titleBase}, you stop being confused when technology surprises you — and you start using it more confidently.\n\n### Key takeaways at a glance\n\n${keyTakeaways}\n\n`;

  const byAngle: Record<EduAngle, string> = {
    "how-it-works": `## How it works, step by step\n\n${steps}\n\n## A closer look\n\nWhen ${topic.titleBase} is working well, each step above happens quickly — sometimes in tiny fractions of a second. If one step fails, the whole chain can pause. That is why checking cables, settings, or permissions often fixes “mystery” problems.\n\nRead the chain slowly. After each step, ask: “What would happen if this step stopped?” That question turns a vague idea into a clear picture.\n\n## Try this thought experiment\n\nExplain ${topic.titleBase} to a younger sibling using only the metaphor: ${topic.metaphor}. If they smile and nod, you understood it. If they look confused, simplify the metaphor even more.\n\n## An India daily-life example\n\nImagine a family in Chennai or Pune using a phone, UPI, and a school WhatsApp group in one evening. Somewhere in that evening, ${topic.titleBase} is quietly helping: a message arrives, a bill is paid, a light stays on, or a page loads. Name the step you can see, then name the hidden step behind it.\n\nA shopkeeper in Coimbatore, a student in Kochi, and a nurse in Lucknow may never say the words “${topic.titleBase}”. Still they depend on it when they tap, pay, search, or save.\n\n## Mini practice\n\n1. Write the four steps in your notebook.\n2. Circle the step that most often fails in real life.\n3. Write one sentence: “If this step fails, I will check ___.”\n`,
    "everyday-life": `## Where you meet this every day\n\nYou probably already used ${topic.titleBase} today without naming it. School apps, lights, payments, maps, and messages all lean on ideas like this.\n\n## A day-in-the-life story\n\nMorning: a device wakes and needs power or signal.\nNoon: you open a site or app that depends on networks and data.\nEvening: you save work to storage or the cloud.\n\nSomewhere in that day, ${topic.titleBase} quietly helped.\n\n## Notice it once\n\nToday, when something digital feels “magic,” pause and ask: which part is ${topic.titleBase} playing?\n\n## Shop, farm, and school\n\nA kirana shop using a billing screen, a farmer checking weather, and a student joining online class are three different lives with one shared idea. ${topic.titleBase} shows up in all three, just wearing different clothes.\n\n## Home, travel, and work\n\nAt home it may look like Wi‑Fi, a TV box, or a phone charger. On a bus it may look like mobile data. At work it may look like a printer, a billing screen, or a shared folder. Same idea. Different clothes.\n\n## A one-day observation sheet\n\nDraw three boxes: morning, afternoon, night. In each box write one time you met ${topic.titleBase}. This small habit makes you a careful observer, not a confused user.\n`,
    "tiny-parts": `## The tiny parts (still in simple words)\n\n${steps}\n\nInside real machines, these steps are done by chips, radios, cables, or code. You do not need to memorize chip names. You only need the job of each part.\n\n## If a part is missing\n\nNo power → nothing starts.\nNo path → messages cannot travel.\nNo instructions → the device sits idle.\nNo memory/storage → work cannot stay.\n\n${topic.titleBase} needs its team of parts working together.\n\n## A repair habit\n\nWhen something fails, ask four questions: power, path, permission, and plan (the instructions). Most “it is broken” stories are one of those four.\n\n## A simple map of parts\n\nThink of four rooms:\n1. The power room — energy to start.\n2. The road room — a path for signals.\n3. The brain room — instructions and decisions.\n4. The cupboard room — memory and saved files.\n\n${topic.titleBase} uses some or all of those rooms. When you know which room is empty, fixing becomes calmer.\n\n## Practice with a real object\n\nPick a phone, a router, or a shop printer. Point to one visible part. Then name the invisible part that supports it. Visible + invisible = understanding.\n`,
    "simple-history": `## A simple history (no boring dates dump)\n\nPeople always wanted faster ways to share ideas and save work. First we had paper and messengers. Then electricity, radio, computers, and networks arrived. Each leap made ${topic.titleBase} more important.\n\n## What changed for children like you\n\nYour grandparents may have waited days for news. You can learn about ${topic.titleBase} in minutes — and then ask our AI to explain a hard word.\n\n## What did not change\n\nCuriosity, carefulness, and kindness still matter more than any gadget.\n\n## Then vs now\n\nThen: one copy, one place, slow sharing.\nNow: many copies, many devices, instant sharing — and a bigger need to check what is true.\n\n## A short story of progress\n\nFirst, people stored knowledge in memory and paper. Then they stored it in machines. Then they connected those machines. Then they made the tools small enough to keep in a pocket. ${topic.titleBase} sits somewhere on that path.\n\nYou do not need every year and every inventor. You need the shape of the story: slower → faster, few people → many people, hard to share → easy to share.\n\n## Why history still helps today\n\nIf you know that tools used to be slower and more expensive, you treat today’s tools with more respect. You also stop fearing every new word. New tools are often old needs wearing new names.\n`,
    "stay-safe": `## Stay safe while using related tools\n\n${topic.titleBase} is helpful, but careless use can cause problems — wasted money, lost files, or leaked secrets.\n\n### Easy safety habits\n\n• Use strong unique passwords.\n• Do not tap strange links.\n• Update apps when asked.\n• Ask an adult before payments.\n• Keep backups of school and business files.\n\n## If something feels wrong\n\nStop. Screenshot. Tell a trusted adult. Change passwords on important accounts.\n\n## A 30-second safety check\n\nBefore you share a photo, pay money, or install an app, ask: “Would I still do this if a clever stranger was watching?” If the answer is no, pause.\n\n## Common traps\n\nA message that shouts “URGENT” is often a trap. A too-good prize is often a trap. A login page that looks almost right, but the address is wrong, is a trap. Slow down. Check the name. Check the URL. Check with a person you trust.\n\n## A family rule you can copy\n\n1. No secret OTPs to anyone.\n2. No unknown APK files.\n3. No payment without a second look.\n4. No public Wi‑Fi for bank work.\n5. Weekly backup of important photos and documents.\n\nThese five rules protect shops, students, and families. They also protect ${topic.titleBase} from being used against you.\n`,
    "myths-vs-truth": `## Myths vs truth\n\n**Myth:** “${topic.titleBase} is pure magic.”\n**Truth:** It follows clear steps you can learn.\n\n**Myth:** “Only geniuses understand this.”\n**Truth:** Clear metaphors — like ${topic.metaphor} — open the door for everyone.\n\n**Myth:** “If it is online, it must be true.”\n**Truth:** Always check sources. Ask our AI for a second explanation, then verify.\n\n**Myth:** “More features always mean better.”\n**Truth:** Simple, reliable tools often win for families and shops.\n\n**Myth:** “Kids cannot learn this until college.”\n**Truth:** A Class 5 student can learn the picture first, then the names later.\n\n**Myth:** “If I ignore it, it will not affect my life.”\n**Truth:** Payments, school, news, and jobs already use it. Learning now is cheaper than panic later.\n\n## How to test a claim\n\nWhen someone says something loud about ${topic.titleBase}, ask three questions:\n1. Who said this?\n2. Can I see a simple example?\n3. What happens if they are wrong?\n\nThat habit is more valuable than any slogan.\n`,
    "explore-more": `## Curious questions you can ask next\n\n• What happens if one step in ${topic.titleBase} fails?\n• How is this similar to ${topic.metaphor}?\n• What would a safer version look like for kids?\n• How do businesses use this idea to help customers?\n• What is one Indian example from a shop, a school, or a hospital?\n• What should I practice for 10 minutes today?\n\n## Your mission\n\nWrite five lines in your own words. Then open Ebenezer AI and paste your lines with: “Explain this more simply and give one example from Indian daily life.”\n\n## Stretch challenge\n\nTeach one friend in 90 seconds. If they can repeat the metaphor ${topic.metaphor}, you both learned it.\n\n## A tiny research project\n\nAsk three people: a parent, a shop worker, and a classmate. “Where do you see ${topic.titleBase}?” Write their answers. You will notice that experts and beginners describe the same world with different words. Your job is to translate between them.\n`,
  };

  const deep = `## A longer explanation, still in easy English\n\nLet us go slower, because worth-learning ideas need room. ${topic.what} That is the seed. Now we grow it.\n\nImagine you are teaching a neighbour who missed the first class. You would not throw hard words at them. You would start with a picture. Our picture is this: ${topic.titleBase} is ${topic.metaphor}. Keep that picture until the end of this lesson.\n\n### What this idea is not\n\nIt is not magic. It is not only for engineers. It is not something you must buy before you can understand it. Understanding comes first. Buying tools comes later, if you even need them.\n\n### What this idea is\n\nIt is a pattern. A pattern is a thing that repeats. Once you see the pattern, you can spot ${topic.titleBase} in a phone, a shop, a website, a school app, or a news page.\n\n## Walk through the steps again, with extra detail\n\n${topic.steps.map((s, i) => `### Step ${i + 1}\n\n${s}\n\nWhy this step exists: without it, the next step has nothing to work with. If you ever get stuck, come back to this step and check it slowly.`).join("\n\n")}\n\n## A classroom story\n\nA teacher writes a word on the board. Some students copy it. Some students only look. The students who copy remember more. This lesson works the same way. If you only skim, ${topic.titleBase} stays foggy. If you write one example from your own day, it becomes yours.\n\nHere is a prompt you can copy into your notebook:\n\n“Today I saw ${topic.titleBase} when ___ . The metaphor that helped me was ${topic.metaphor}. If it failed, I would check ___ .”\n\n## India examples you can use in a speech or exam\n\n1. A parent pays school fees on a phone. Somewhere in that tap, ${topic.titleBase} may be helping quietly.\n2. A tailor in Tiruppur shares a design photo on WhatsApp. The photo travels because digital paths exist.\n3. A clinic prints a token number. The printer, the cable, and the software must agree.\n4. A student in a village joins a class on mobile data when home Wi‑Fi is weak.\n5. A shop prints a GST bill. The bill is paper, but the thinking behind it is digital.\n\nPick one example. Rewrite it in your own town name. That is how knowledge becomes local, not borrowed.\n\n## Common mistakes beginners make\n\n• Mixing the name of a brand with the name of the idea. WhatsApp is an app. The internet is bigger than one app.\n• Thinking a problem is “the whole computer” when one small setting is wrong.\n• Sharing passwords because a screen looks official.\n• Downloading a file from a random link because it promises speed.\n• Giving up after one confusing video.\n\nYou can avoid these mistakes by staying with simple questions: What is the goal? What is the next step? Who can I ask?\n\n## Words that often appear near this topic\n\nYou may hear people say data, signal, account, file, update, backup, or network. Do not freeze. Each word is just a label. If a word is new, replace it with a picture. Data is stuff you want to keep. A signal is a message on a road. An account is a named locker. A file is a packed notebook. An update is a repair pack. A backup is a spare copy.\n\nWhen you meet a new word around ${topic.titleBase}, write the picture, not only the spelling.\n\n## How shops and families can use this\n\nIf you run a small shop, this idea can save time: fewer lost bills, fewer “the system is down” panics, clearer talking with a technician. If you are a student, it can save marks: you can explain, not only memorise. If you are a parent, it can save money: you can spot a scam faster.\n\n${topic.whyItMatters}\n\n## A 10-minute practice plan\n\nMinute 1–2: Read the metaphor again: ${topic.metaphor}.\nMinute 3–5: Teach the four steps out loud, even if you are alone.\nMinute 6–8: Find one real object in the room that connects to ${topic.titleBase}.\nMinute 9–10: Write one question you still have. Ask that question on Ebenezer AI.\n\nShort practice beats long worry.\n\n## What to do when it fails\n\nFailure is a teacher. When ${topic.titleBase} seems broken, do not restart everything at once. Change one thing. Wait. Check. Then change the next thing. Technicians work like this. You can work like this too.\n\nA calm order:\n1. Power.\n2. Connection.\n3. Login or permission.\n4. The app or file itself.\n5. Ask for help with a screenshot.\n\n## How this journal, the store, and Eben AI fit together\n\nThis article is the map. The Ebenezer Store has kits if you want to build a page, a brand, a shop bill, or a form. Eben AI is the tutor who can explain the same map in Tamil, Hindi, or simpler English. News on Ebenezer News shows the live world where these ideas keep moving.\n\nYou do not have to use every product. You only need to know they exist when you are ready.\n\n## A closing picture\n\nIf you remember only one sentence, remember this: ${topic.titleBase} is ${topic.metaphor}. If you remember two, add this: ${topic.whyItMatters} If you remember three, add one Indian example from your own street.\n\nThat is enough to be a confident learner. The rest is practice.\n`;

  return `${base}${byAngle[angle]}\n${deep}\n## Did you know? Fun facts that surprise people\n\n${facts}\n\nMost people use ${topic.titleBase} every day without knowing how it works. Now you are ahead of them.\n\n## FAQ — honest answers\n\n### Can a Class 5 student understand this?\nYes. We start with a picture (${topic.metaphor}) and only then add steps. Adults can read the same pages without feeling talked down to, because the ideas are real.\n\n### Do I need to buy new gadgets?\nUsually no. Understanding ${topic.titleBase} helps you use tools you already have — phone, Wi‑Fi, a shop counter, or a website.\n\n### How long should I spend on this lesson?\nTwelve to twenty minutes is a good first pass. Then come back tomorrow and teach someone else. Teaching is the test.\n\n### What is the single most important thing to remember?\n${topic.steps[0]}\n\n### Is this useful for my shop or freelance work?\nYes. Clear thinking about ${topic.titleBase} reduces wasted time, failed payments, and confused customers.\n\n### What should I do after reading?\n1. Re-read the key takeaways.\n2. Write one local example.\n3. Open a linked lesson in Continue the chain.\n4. Ask Eben AI one follow-up question in your language.\n\n## 3 things to do today\n\n1. Notice it — find where ${topic.titleBase} appears in your own day.\n2. Explain it — use the metaphor (${topic.metaphor}) to tell a friend or family member.\n3. Go deeper — click a Continue the chain lesson and read the next linked idea.\n\n## Ask Ebenezer AI\n\nStill curious about “${title}”? Open /ai and ask follow-up questions in your language. The AI gives extra examples, harder explanations, or simpler ones — whatever you need right now.\n\n## Grow with Ebenezer tools\n\nLearning is the first step. When you are ready to build — a website, a shop, a brand, or a billing system — visit the Ebenezer Store. Kits and tools are made for people who want to move from understanding to doing.\n`;
}
...
export function getEduPosts(): EduPost[] {
  ...
  for (const topic of EDU_TOPICS) {
    ...
    for (let angleIdx = 0; angleIdx < EDU_ANGLES.length; angleIdx++) {
      const angle = EDU_ANGLES[angleIdx];
