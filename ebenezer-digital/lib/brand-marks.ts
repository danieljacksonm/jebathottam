...
export const E_MARKS = {
  ...
  tools: "/brand/ebenezer-tools-mark.svg",
  discover: "/brand/ebenezer-discover-mark.svg",
  catalog: "/brand/ebenezer-catalog-mark.svg",
  network: "/brand/ebenezer-network-mark.svg",
  info: "/brand/info-logo.svg",
