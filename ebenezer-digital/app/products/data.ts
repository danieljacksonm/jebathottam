...
export const STORE_PRODUCTS: StoreProduct[] = [
  ...
  /* ── 8. Travel Enquiry Pack ──────────────────────────── */
  {
    ...
    pdfs: [
      ...
      { label: "Closing scripts (6 approaches)", file: "/downloads/pdfs/travel-enquiry-pack/whatsapp-scripts.pdf" },
      { label: "Review request scripts", file: "/downloads/pdfs/travel-enquiry-pack/quotation-template.pdf" },
    ],
  ...
  /* ── 10. Brand Kit Essentials ────────────────────────── */
  {
    ...
    pdfs: [
      ...
      { label: "Brand consistency checklist", file: "/downloads/pdfs/brand-kit-essentials/social-templates.pdf" },
    ],
  ...
  /* ── 11. Free Enquiry Form Kit ───────────────────────── */
  {
    ...
    pdfs: [
      ...
      { label: "WhatsApp enquiry script", file: "/downloads/pdfs/free-enquiry-form-kit/digital-fields.pdf" },
      { label: "Follow-up process guide", file: "/downloads/pdfs/free-enquiry-form-kit/enquiry-form.pdf" },
    ],
...

  {
    ...
    tagline: "Create a supplier purchase order and print it today.",
    description:
      "Live purchase order tool for shops: supplier details, needed-by date, line items, and totals. Print or save as PDF from the browser.",
    story: "Shops still draft POs in Word. This generator gives a clean order form in minutes.",
    category: "Software & Tools",
    productType: "digital_tool",
    accessMethod: "web_app",
    techStack: ["HTML", "CSS", "JavaScript"],
    ...
    fileFormats: ["Print", "PDF (browser print)"],
    version: "1.0",
    tags: ["purchase-order", "shop", "supplier", "inventory"],
    difficulty: "beginner",
    demoUrl: "/tools/purchase-order-generator",
    faq: [{ q: "Is stock deducted automatically?", a: "No. This prints a PO. Connect stock in Ebenezer SaaS separately if needed." }],
    price: 0,
    badge: "NEW",
    isFree: true,
    isSoftware: true,
    externalUrl: "/tools/purchase-order-generator",
    externalCta: "Open purchase order tool",
    image: U("photo-1586528116311-ad8dd3c8310d"),
    gallery: [U("photo-1586528116311-ad8dd3c8310d")],
    features: ["Supplier fields", "Needed-by date", "Print / Save as PDF"],
    includes: ["Browser purchase order generator"],
    compatibility: ["Chrome", "Edge", "Firefox", "Safari"],
    license: ["Free to use for your business"],
    whoItIsFor: "Retail shops and wholesalers ordering from suppliers.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    seoTitle: "Free Purchase Order Generator – Print Supplier POs",
    seoDescription: "Create and print purchase orders for suppliers in your browser. Free tool from Ebenezer Store.",
  },

  {
    ...
    slug: "task-tracker",
    name: "Task Tracker",
    tagline: "Simple to-do list with due dates in your browser.",
    description:
      "A lightweight task tracker saved on your device. Add tasks, mark done, set due dates. No account required.",
    story: "Teams and freelancers need a fast checklist without installing another app.",
    ...
    platforms: ["Web"],
    version: "1.0",
    tags: ["productivity", "task", "todo"],
    difficulty: "beginner",
    demoUrl: "/tools/task-tracker",
    faq: [{ q: "Where is data stored?", a: "In your browser localStorage only. Export is not required for basic use." }],
    price: 0,
    badge: "NEW",
    isFree: true,
    isSoftware: true,
    externalUrl: "/tools/task-tracker",
    externalCta: "Open task tracker",
    image: U("photo-1484480974693-6ca0a78fb36b"),
    gallery: [U("photo-1484480974693-6ca0a78fb36b")],
    features: ["Due dates", "Done / open counts", "Device-local save"],
    includes: ["Browser task tracker"],
    compatibility: ["Modern browsers"],
    license: ["Free to use"],
    whoItIsFor: "Freelancers, students, and small teams.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    seoTitle: "Free Task Tracker – Browser To-Do List",
    seoDescription: "Free browser task tracker with due dates. Data stays on your device.",
  },

  {
    ...
    tagline: "HTML site for agencies: listings, about, and enquiry CTA.",
    description: "Real HTML/CSS/JS real estate marketing site with listings grid and WhatsApp contact. Download source — not screenshots only.",
    story: "Agents need a fast listing site before custom CRM builds.",
    ...
    fileFormats: ["HTML", "CSS", "JS", "ZIP"],
    version: "1.0",
    tags: ["real-estate", "property", "agent", "html"],
    difficulty: "beginner",
    previewUrl: "/downloads/packs/real-estate-website-template/index.html",
    demoUrl: "/downloads/packs/real-estate-website-template/index.html",
    price: 0,
    badge: "NEW",
    isFree: true,
    image: U("photo-1560518883-ce09059eeffa"),
    gallery: [U("photo-1560518883-ce09059eeffa")],
    features: ["Listings page", "About + contact", "WhatsApp CTA"],
    includes: ["index.html, listings.html, about.html, contact.html", "styles.css, script.js", "README.md, LICENSE.txt"],
    downloadContentsPlan: ["index.html", "listings.html", "about.html", "contact.html", "styles.css", "script.js", "README.md", "LICENSE.txt"],
    compatibility: ["Any static host"],
    license: ["Personal and commercial use for agency sites"],
    whoItIsFor: "Real estate agents and property brokers.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    downloadFile: "/downloads/real-estate-website-template.zip",
    fileName: "real-estate-website-template.zip",
    fileSize: "HTML + CSS + JS source",
    seoTitle: "Free Real Estate Website Template – HTML Download",
    seoDescription: "Free real estate website template with listings and contact pages. Real HTML source.",
  },

  {
    ...
    tagline: "Healthcare clinic site with services, doctors, and booking CTA.",
    description: "HTML clinic website: services, doctors, and WhatsApp booking. Editable source included.",
    story: "Clinics need a trustworthy web presence with a clear book path.",
    category: "Healthcare",
    productType: "website_template",
    accessMethod: "download",
    techStack: ["HTML", "CSS", "JavaScript"],
    platforms: ["Static hosting"],
    version: "1.0",
    tags: ["clinic", "healthcare", "dental", "html"],
    difficulty: "beginner",
    previewUrl: "/downloads/packs/clinic-website-template/index.html",
    demoUrl: "/downloads/packs/clinic-website-template/index.html",
    price: 0,
    badge: "NEW",
    isFree: true,
    image: U("photo-1519494026892-80bbd2d6fd0d"),
    gallery: [U("photo-1519494026892-80bbd2d6fd0d")],
    features: ["Services + doctors pages", "Booking CTA", "No build step"],
    includes: ["index.html, services.html, doctors.html, contact.html", "styles.css, script.js", "README + LICENSE"],
    downloadContentsPlan: ["index.html", "services.html", "doctors.html", "contact.html", "styles.css", "script.js", "README.md", "LICENSE.txt"],
    compatibility: ["Any static host"],
    license: ["Personal and commercial use for clinics"],
    whoItIsFor: "Clinics, dental practices, and small hospitals.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    downloadFile: "/downloads/clinic-website-template.zip",
    fileName: "clinic-website-template.zip",
    fileSize: "HTML + CSS + JS source",
    seoTitle: "Free Clinic Website Template – HTML Download",
    seoDescription: "Free healthcare clinic website template with services, doctors, and booking pages.",
  },

  {
    id: "dp-edu-site",
    slug: "education-website-template",
    name: "Education Website Template",
    tagline: "Course and institute landing site in HTML.",
    description: "Education marketing site with courses, about, and enroll CTA. Real source files.",
    story: "Coaches and institutes need a clean enroll page before LMS complexity.",
    category: "Education",
    productType: "website_template",
    accessMethod: "download",
    techStack: ["HTML", "CSS", "JavaScript"],
    platforms: ["Static hosting"],
    version: "1.0",
    tags: ["education", "course", "school", "html"],
    difficulty: "beginner",
    previewUrl: "/downloads/packs/education-website-template/index.html",
    demoUrl: "/downloads/packs/education-website-template/index.html",
    price: 0,
    badge: "NEW",
    isFree: true,
    image: U("photo-1523050854058-8df90110c9f1"),
    gallery: [U("photo-1523050854058-8df90110c9f1")],
    features: ["Courses page", "Enroll CTA", "WhatsApp helper"],
    includes: ["index.html, courses.html, about.html, contact.html", "styles.css, script.js", "README + LICENSE"],
    downloadContentsPlan: ["index.html", "courses.html", "about.html", "contact.html", "styles.css", "script.js", "README.md", "LICENSE.txt"],
    compatibility: ["Any static host"],
    license: ["Personal and commercial use for education sites"],
    whoItIsFor: "Coaches, tutors, and small institutes.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    downloadFile: "/downloads/education-website-template.zip",
    fileName: "education-website-template.zip",
    fileSize: "HTML + CSS + JS source",
    seoTitle: "Free Education Website Template – HTML Download",
    seoDescription: "Free education and course website template with enroll CTA. Real HTML source.",
  },

  {
    id: "dp-photo-site",
    slug: "photography-website-template",
    name: "Photography Website Template",
    tagline: "Photographer portfolio with gallery cards and booking CTA.",
    description: "HTML photography site: work grid, about, and book shoot. Download real source.",
    story: "Photographers need a portfolio that converts enquiries without WordPress.",
    category: "Creator",
    productType: "website_template",
    accessMethod: "download",
    techStack: ["HTML", "CSS", "JavaScript"],
    platforms: ["Static hosting"],
    version: "1.0",
    tags: ["photography", "portfolio", "creator", "html"],
    difficulty: "beginner",
    previewUrl: "/downloads/packs/photography-website-template/index.html",
    demoUrl: "/downloads/packs/photography-website-template/index.html",
    price: 0,
    badge: "NEW",
    isFree: true,
    image: U("photo-1452587925148-ce544e77e70d"),
    gallery: [U("photo-1452587925148-ce544e77e70d")],
    features: ["Gallery cards", "About + book pages", "WhatsApp CTA"],
    includes: ["index.html, about.html, contact.html", "styles.css, script.js", "README + LICENSE"],
    downloadContentsPlan: ["index.html", "about.html", "contact.html", "styles.css", "script.js", "README.md", "LICENSE.txt"],
    compatibility: ["Any static host"],
    license: ["Personal and commercial use for photographer sites"],
    whoItIsFor: "Photographers and visual creators.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    downloadFile: "/downloads/photography-website-template.zip",
    fileName: "photography-website-template.zip",
    fileSize: "HTML + CSS + JS source",
    seoTitle: "Free Photography Website Template – HTML Download",
    seoDescription: "Free photographer portfolio website template with gallery and booking pages.",
  },

  {
    id: "dp-cafe-site",
    slug: "cafe-website-template",
    name: "Cafe Website Template",
    tagline: "Cafe site with menu page — pairs with QR Menu Generator.",
    description: "HTML cafe website with menu, about, and visit CTA. Use with our QR menu tool for tables.",
    story: "Cafes need a simple menu site and table QR path.",
    category: "Restaurant",
    productType: "website_template",
    accessMethod: "download",
    techStack: ["HTML", "CSS", "JavaScript"],
    platforms: ["Static hosting"],
    version: "1.0",
    tags: ["cafe", "restaurant", "menu", "html"],
    difficulty: "beginner",
    previewUrl: "/downloads/packs/cafe-website-template/index.html",
    demoUrl: "/downloads/packs/cafe-website-template/index.html",
    faq: [{ q: "Does this include a QR code?", a: "Use the free QR Menu Generator product for table QR links." }],
    price: 0,
    badge: "NEW",
    isFree: true,
    image: U("photo-1501339847302-ac426a4a7cbb"),
    gallery: [U("photo-1501339847302-ac426a4a7cbb")],
    features: ["Menu page", "Visit CTA", "WhatsApp helper"],
    includes: ["index.html, menu.html, about.html, contact.html", "styles.css, script.js", "README + LICENSE"],
    downloadContentsPlan: ["index.html", "menu.html", "about.html", "contact.html", "styles.css", "script.js", "README.md", "LICENSE.txt"],
    compatibility: ["Any static host"],
    license: ["Personal and commercial use for cafes"],
    whoItIsFor: "Cafes, bakeries, and small restaurants.",
    publishedAt: "2026-08-20",
    status: "published",
    rating: 5,
    reviews: 0,
    downloadFile: "/downloads/cafe-website-template.zip",
    fileName: "cafe-website-template.zip",
    fileSize: "HTML + CSS + JS source",
    seoTitle: "Free Cafe Website Template – HTML Menu Site",
    seoDescription: "Free cafe website template with menu page. Pair with QR Menu Generator for tables.",
  },

  /* ── Next.js SaaS Starter (DRAFT — no repo yet) ──── */
  {
