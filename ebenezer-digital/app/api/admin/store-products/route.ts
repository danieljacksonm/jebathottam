...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const product = await db.createDigitalProduct({
      ...
      story: body.story || "",
      category: body.category || "Software & Tools",
      productType: body.productType || "free_resource",
      ...
      canvaLink: body.canvaLink,
      figmaLink: body.figmaLink,
      faq: Array.isArray(body.faq) ? body.faq : undefined,
      tags: Array.isArray(body.tags) ? body.tags : undefined,
      difficulty: body.difficulty,
      nextjsVersion: body.nextjsVersion,
      reactVersion: body.reactVersion,
      nodeRequirement: body.nodeRequirement,
      ...
      fileFormats: Array.isArray(body.fileFormats) ? body.fileFormats : undefined,
      version: body.version,
      updatePolicy: body.updatePolicy,
      setupRequirements: body.setupRequirements,
