    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12 pb-8 border-b border-gray-800">
          <p className="text-xl md:text-2xl font-serif italic text-white/90 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400 mb-6">
              <li>{ministryInfo.email}</li>
              <li>{ministryInfo.phone}</li>
              <li className="text-gray-500">{ministryInfo.address}</li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} {ministryInfo.name} - {ministryInfo.subtitle}. All rights reserved. Built with care for longevity.
          </p>
        </div>
      </div>
    </footer>
