<?php
/**
 * Traders Android app download page (public — no login).
 */
$apkRel = 'downloads/yegova-traders.apk';
...
if (isset($_GET['file']) && $_GET['file'] === '1' && $hasApk) {
    ...
    header('Content-Disposition: attachment; filename="Yegova-Traders.apk"');
...
<head>
    ...
    <title>Download Yegova Traders App</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #92400e; min-height: 100vh; }
...
<body class="d-flex align-items-center py-4">
    <div class="container">
        <div class="card shadow p-4 text-center">
            ...
            <h1 class="h3">Yegova Traders</h1>
            <p class="text-muted mb-3">Android app for GST Traders billing (opens the website).</p>

            <?php if ($hasApk): ?>
                <a href="download_app.php?file=1" class="btn btn-warning btn-lg w-100 mb-2">
                ...
                <ol class="text-start small text-muted">
                    ...
                    <li>Open <strong>Yegova Traders</strong> icon</li>
                </ol>
            <?php else: ?>
                <div class="alert alert-warning text-start mb-0">
                    ...
                    <code>mobile-apps/traders</code>, then copy
                    <code>app-debug.apk</code> to
                    <code>downloads/yegova-traders.apk</code> on this server.
                </div>
            <?php endif; ?>
