    ...
    <div class="tab-content mt-3">
        ...
        <div class="tab-pane fade show active" id="bill">
            <div class="d-flex justify-content-end mb-2">
                <button class="btn btn-danger btn-sm" onclick="downloadPDF('billTable','Bill Report')">⬇ Download PDF</button>
            </div>
        ...
        <div class="tab-pane fade" id="product">
            <div class="d-flex justify-content-end mb-2">
                <button class="btn btn-danger btn-sm" onclick="downloadPDF('productTable','Bill Report')">⬇ Download PDF</button>
            </div>
        ...
        <div class="tab-pane fade" id="date">
            <div class="d-flex justify-content-end mb-2">
                <button class="btn btn-danger btn-sm" onclick="downloadPDF('dateTable','Bill Report')">⬇ Download PDF</button>
            </div>
        ...
        <div class="tab-pane fade" id="stock">
            <div class="d-flex justify-content-end mb-2">
                <button class="btn btn-danger btn-sm" onclick="downloadPDF('stockTable','Bill Report')">⬇ Download PDF</button>
            </div>
        ...
        <div class="tab-pane fade" id="stockonly">
            <div class="d-flex justify-content-end mb-2">
                <button class="btn btn-danger btn-sm" onclick="downloadPDF('stockonlyTable','Bill Report')">⬇ Download PDF</button>
            </div>
