...
$result = $conn->query("SELECT DISTINCT b.id, b.paid_amount, b.billname, b.address, b.phone, b.total, b.bill_date, b.gst_fy, b.gst_serial
                        FROM bills b
                        WHERE " . gstTradersBillFilterSql() . "
...
<div class="mb-3">
    <input type="search" id="billSearch" class="form-control form-control-lg mb-2" placeholder="🔍 Search bill no, customer, phone..." autocomplete="off">
