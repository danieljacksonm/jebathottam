...
try {
    ...
    $sql = "INSERT INTO bills (billname, address, phone, total, bill_date,old_payment,discount_type,discount_value) 
            VALUES ('$bill_name', '$address', '$phone', $total, NOW(), '$old_payment', '$discount_type', $discount_value)";
    if (!$conn->query($sql)) {
