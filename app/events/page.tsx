...
export const metadata = {
  title: 'Events - Ministry Platform',
  description: 'Upcoming ministry events and gatherings.',
};

export default function EventsPage() {
  // Sample events - replace with actual data from API
  const upcomingEvents = [
    {
      ...
      description: 'Join us for our weekly worship service featuring praise, prayer, and biblical teaching.',
      type: 'Worship',
    },
    {
      id: 2,
      ...
      description: 'In-depth Bible study focusing on the book of Romans. All are welcome to join.',
      type: 'Study',
    },
    {
      id: 3,
      ...
      description: 'Corporate prayer meeting for intercession, worship, and seeking God together.',
      type: 'Prayer',
    },
    {
      id: 4,
      ...
      description: 'Special event for youth ages 13-18. Games, worship, and relevant teaching.',
      type: 'Youth',
    },
    {
      id: 5,
      ...
      time: '10:00 AM',
      location: 'Fellowship Hall',
      description: 'Monthly gathering for women to connect, encourage one another, and study God\'s word together.',
      type: 'Fellowship',
    },
    {
      id: 6,
      ...
      time: '8:00 AM',
      location: 'Fellowship Hall',
      description: 'Men\'s breakfast gathering with food, fellowship, and discussion about living out faith in daily life.',
      type: 'Fellowship',
    },
  ];
