...
/** Temporary: same English for ta/hi until translations are ready. */
const L = (en: string): LocalizedString => ({ en, ta: en, hi: en });
const LL = (en: string[]): LocalizedStringList => ({ en, ta: en, hi: en });

const DARJEELING_DAY1_DAWAIPANI: ItineraryDay = {
  day: 1,
  title: L("NJP → Dawaipani"),
  parts: [
    {
      label: L("Transfer & sightseeing"),
      detail: L(
        "NJP to Dawaipani. Visit Lovers viewpoint, Peshok tea garden, Gumbadara viewpoint, and Lamhatta pine forest. Reach homestay; leisure in the evening. Bonfire/BBQ facilities available (not included in package price).",
      ),
    },
    {
      label: L("Meals"),
      detail: L("Lunch, Dinner, Snacks & Breakfast included."),
    },
  ],
  overnight: L("Overnight at Dawaipani homestay"),
};

const DARJEELING_DAY2_SIGHTSEEING: ItineraryDay = {
  day: 2,
  title: L("Darjeeling sightseeing"),
  parts: [
    {
      label: L("Day"),
      detail: L(
        "Darjeeling sightseeing and drop: Batasia Loop, Ghoom Monastery, Himalayan Zoological Park, Mountaineering Institute & Museum, Happy Valley Tea Estate, Japanese Temple, Peace Pagoda, Tibetan Refugee camp (if open). Reach hotel. Mall Road and local market by walk.",
      ),
    },
    {
      label: L("Meals"),
      detail: L("Dinner & Breakfast included."),
    },
  ],
  overnight: L("Overnight stay at Darjeeling"),
};

const DARJEELING_SHARED_EXCLUSIONS = LL([
  "Bonfire",
  "BBQ",
  "Usage of vehicle outside itinerary",
  "Syndicate parking cost (if any)",
  "Personal expenses and tips",
]);

const DARJEELING_SHARED_TRANSPORT = LL([
  "Sumo / Bolero / Innova (NJP to NJP) — whichever is available",
]);

const DARJEELING_PRICING = LL([
  "₹6,550 per person based on 7 guests (owner quote)",
  "Contact Canaan to confirm pricing for your group size",
...
export const packageDetails: Record<PackageId, PackageDetails> = {
  ...
  "darjeeling-3n4d-mimbusty": {
    suitableFor: L("Groups (owner quote based on 7 guests — confirm for your size)"),
    startingLocation: L("NJP (New Jalpaiguri)"),
    destination: L("Darjeeling circuit"),
    hotelCategory: L("Homestay (Dawaipani & Mimbusty) and hotel (Darjeeling) as per plan"),
    transportSummary: L("Sumo / Bolero / Innova — NJP to NJP"),
    mealPlan: L(
      "Day 1: Lunch, Dinner, Snacks & Breakfast · Day 2: Dinner & Breakfast · Day 3: Lunch, Snacks, Dinner & Breakfast · Day 4: as per departure schedule",
    ),
    pricingAssumptions: DARJEELING_PRICING,
    inclusions: LL([
      "3 nights stay as per itinerary",
      "Meals as listed each day",
      "Sightseeing as per plan (Dawaipani, Darjeeling, Mimbusty, Mirik return)",
      "Sumo / Bolero / Innova transport NJP–NJP",
    ]),
    exclusions: DARJEELING_SHARED_EXCLUSIONS,
    accommodationNote: L(
      "Homestay at Dawaipani and Mimbusty (Kanchenjunga view); hotel overnight in Darjeeling. Exact properties confirmed at booking based on availability.",
    ),
    transportDetails: DARJEELING_SHARED_TRANSPORT,
    cancellationPolicy: OWNER_TODO_CANCEL,
    paymentTerms: OWNER_TODO_PAY,
    itinerary: [
      DARJEELING_DAY1_DAWAIPANI,
      DARJEELING_DAY2_SIGHTSEEING,
      {
        day: 3,
        title: L("Darjeeling → Mimbusty (Kanchenjunga view)"),
        parts: [
          {
            label: L("Day"),
            detail: L(
              "Darjeeling to Mimbusty (Kanchenjunga view stay). Visit Lepchajagat pine forest and Majhidhura (Mini Pehelgham). Reach homestay; leisure in the evening. Bonfire/BBQ facilities available (not included in package price).",
            ),
          },
          {
            label: L("Meals"),
            detail: L("Lunch, Snacks, Dinner and Breakfast included."),
          },
        ],
        overnight: L("Overnight at Mimbusty homestay"),
      },
      {
        day: 4,
        title: L("Return to NJP via Mirik"),
        parts: [
          {
            label: L("Day"),
            detail: L(
              "Return to NJP via Mirik. Visit Simana viewpoint, Nepal border market / Pashupati fatak, Gopaldhara Tea estate, and Mirik Lake & pine forest. Drop at NJP.",
            ),
          },
        ],
      },
    ...
    faqs: [
      {
        question: L("What is the published price?"),
        answer: L(
          "₹6,550 per person based on 7 guests (owner quote). Contact us to confirm for your group size.",
        ),
      },
      {
        question: L("Where does the tour start and end?"),
        answer: L("NJP (New Jalpaiguri) to NJP."),
      },
      {
        question: L("Is Bonfire or BBQ included?"),
        answer: L(
          "Facilities may be available at homestays, but Bonfire and BBQ are excluded from the package price.",
        ),
      },
    ],
  },
  ...
  "darjeeling-3n4d-tabakoshi": {
    ...
    startingLocation: L("NJP (New Jalpaiguri)"),
    destination: L("Darjeeling circuit"),
    hotelCategory: L("Homestay (Dawaipani & Tabakoshi) and hotel (Darjeeling) as per plan"),
    transportSummary: L("Sumo / Bolero / Innova — NJP to NJP"),
    mealPlan: L(
      "Day 1: Lunch, Dinner, Snacks & Breakfast · Day 2: Dinner & Breakfast · Day 3: Lunch, Snacks, Dinner & Breakfast · Day 4: as per departure schedule",
    ),
    ...
    inclusions: LL([
      "3 nights stay as per itinerary",
      "Meals as listed each day",
      "Sightseeing as per plan (Dawaipani, Darjeeling, Tabakoshi, Mirik return)",
      "Sumo / Bolero / Innova transport NJP–NJP",
    ]),
    exclusions: DARJEELING_SHARED_EXCLUSIONS,
    accommodationNote: L(
      "Homestay at Dawaipani and Tabakoshi (mountain riverside); hotel overnight in Darjeeling. Exact properties confirmed at booking based on availability.",
    ),
    transportDetails: DARJEELING_SHARED_TRANSPORT,
    cancellationPolicy: OWNER_TODO_CANCEL,
    paymentTerms: OWNER_TODO_PAY,
    itinerary: [
      ...
      {
        day: 3,
        title: L("Darjeeling → Tabakoshi (mountain riverside)"),
        parts: [
          {
            label: L("Day"),
            detail: L(
              "Darjeeling to Tabakoshi (mountain riverside stay). Visit Lepchajagat pine forest, Simana viewpoint, and Nepal border market / Pashupati fatak. Reach homestay; leisure in the evening. Bonfire/BBQ facilities available (not included in package price).",
            ),
          },
          {
            label: L("Meals"),
        ...
        overnight: L("Overnight at Tabakoshi homestay"),
      },
      {
        day: 4,
        title: L("Return to NJP via Mirik"),
        parts: [
          {
            label: L("Day"),
            detail: L(
              "Return to NJP via Mirik. Visit Gopaldhara Tea estate and Mirik Lake & pine forest. Drop at NJP.",
            ),
          },
        ],
      },
    ...
    faqs: [
      ...
      {
        question: L("How does Tabakoshi differ from Mimbusty?"),
        answer: L(
          "Day 3 stays at Tabakoshi riverside and includes Simana / Nepal border on that day; Day 4 returns via Gopaldhara and Mirik Lake (no Simana on Day 4).",
        ),
      },
    ],
  },
